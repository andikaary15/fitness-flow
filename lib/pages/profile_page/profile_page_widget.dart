...
class _ProfilePageWidgetState extends State<ProfilePageWidget>
  ...
  int updateProfile() {
    // if (user != null) {
    // } else {,,_model.textControllerBerat.text,_model.textControllerUmur.text,_model.textControllerTinggi.text
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (snapshot.data != null) {
                ...
                _model.textControllerTinggi.text = users.tinggi.toString();
              }
                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: Image.network('https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D').image,
                            ),
                          ),
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: 
                                              TextFormField(
                                                controller: _model.textControllerNama,
                                                focusNode: _model.textFieldFocusNodeNama,
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              TextFormField(
                                                ...
                                                focusNode: _model.textFieldFocusNodePassword,
                                                obscureText: true,
                                                decoration: InputDecoration(
                                                  border: OutlineInputBorder(
                                                    borderRadius: BorderRadius.circular(100),
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: 
                                              TextFormField(
                                                controller: _model.textControllerBerat,
                                                focusNode: _model.textFieldFocusNodeBerat,
                                                decoration: InputDecoration(
                                                  border: OutlineInputBorder(
                                                    borderRadius: BorderRadius.circular(100),
                                                  ),
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: 
                                              TextFormField(
                                                controller: _model.textControllerUmur,
                                                focusNode: _model.textFieldFocusNodeUmur,
                                                decoration: InputDecoration(
                                                  border: OutlineInputBorder(
                                                    borderRadius: BorderRadius.circular(100),
                                                  ),
                                                  ...
                                                  label: Text("Umur", style: GoogleFonts.poppins(),),
                                                  floatingLabelStyle: GoogleFonts.poppins(color: Color.fromRGBO(80, 70, 227, 1)),
                                                  prefixIconColor:  const Color.fromRGBO(80, 70, 227, 1),
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: 
                                              TextFormField(
                                                controller: _model.textControllerTinggi,
                                                focusNode: _model.textFieldFocusNodeTinggi,
                                                decoration: InputDecoration(
                                                  border: OutlineInputBorder(
                                                    borderRadius: BorderRadius.circular(100),
                                                  ),
                                                  ...
                                                  label: Text("Tinggi", style: GoogleFonts.poppins(),),
                                                  floatingLabelStyle: GoogleFonts.poppins(color: Color.fromRGBO(80, 70, 227, 1)),
                                                  prefixIconColor:  const Color.fromRGBO(80, 70, 227, 1),
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(24.0, 210.0, 0.0, 0.0),
                            child: Container(
                              width: 60.0,
                              height: 60.0,
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: byte64String != null ? Image.memory(const Base64Decoder().convert(byte64String!)).image : (users.foto != '' ? Image.memory(const Base64Decoder().convert(users.foto)).image : Image.network('https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png').image),
                                ),

                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: lakiCheckbox ? FlutterFlowTheme.of(context).secondary : Colors.white,
                                      boxShadow: [
                                        BoxShadow(
                                          blurRadius: 24.0,
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: FlutterFlowTheme.of(context)
                                                ...
                                                .override(
                                                  fontFamily: 'Rubik',
                                                  color: !lakiCheckbox ? FlutterFlowTheme.of(context).primary : Colors.white,
                                                  fontWeight: FontWeight.w500,
                                                ),
                                          ),
                                        ],
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    height: 216.0,
                                    decoration: BoxDecoration(
                                      color: perempuanCheckbox ? FlutterFlowTheme.of(context).secondary : Colors.white,
                                      boxShadow: [
                                        BoxShadow(
                                          blurRadius: 24.0,
                                          color: Color(0x0D000000),
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: FlutterFlowTheme.of(context)
                                                ...
                                                .override(
                                                  fontFamily: 'Rubik',
                                                  color: !perempuanCheckbox ? FlutterFlowTheme.of(context).primary : Colors.white,
                                                  fontWeight: FontWeight.w500,
                                                ),
                                          ),
                                        ],
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            84.0, 0.0, 84.0, 0.0),
                        child: Text(
                          'Untuk memberi Anda pengalaman penyesuaian, kami perlu mengetahui jenis kelamin Anda',
                          textAlign: TextAlign.center,
                          style:

...
class _ProfilePictureWidgetState extends State<ProfilePictureWidget>
  ...
  loginUser() {
    return futureUser = fitnessFlowDB.login(_model.textController.text, _model.textController2.text);
  }
  @override
  void dispose() {
    _model.dispose();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Silakan masukkan nama dan password untuk melanjutkan login',
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Rubik',
                              fontSize: 14.0,

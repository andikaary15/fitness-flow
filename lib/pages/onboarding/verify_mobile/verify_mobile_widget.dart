                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Masukan berat badanmu sekarang',
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Rubik',
                              fontSize: 14.0,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                hintText: 'Masukan target berat badanmu',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                                      fontFamily: 'Rubik',
                                ...
                                child: FFButtonWidget(
                                  ...
                                  options: FFButtonOptions(
                                    ...
                                    iconPadding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 0.0),
                                    color: lbsCheckbox ? FlutterFlowTheme.of(context).secondary : Colors.white,
                                    textStyle: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
                                          fontFamily: 'Rubik',
                                          color: !lbsCheckbox ? FlutterFlowTheme.of(context).secondaryText : Colors.white,
                                          fontSize: 14.0,
                                          fontWeight: FontWeight.normal,
                                        ),
                                    elevation: 0.0,
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  ...
                                  options: FFButtonOptions(
                                    ...
                                    iconPadding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 0.0),
                                    color: kgCheckbox ? FlutterFlowTheme.of(context).secondary : Colors.white,
                                    textStyle: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
                                          fontFamily: 'Rubik',
                                          color: !kgCheckbox ? FlutterFlowTheme.of(context).secondaryText : Colors.white,
                                          fontSize: 14.0,
                                          fontWeight: FontWeight.normal,
                                        ),
                                    elevation: 2.0,
